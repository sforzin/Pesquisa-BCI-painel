...
def generate_signal(freqs, fases, Ts, interval, rest_pause):
    ...
    def save_to_header(data, filename="sinal_base.h"):
        ...
        with open(filename, "w") as f:
            ...
            f.write(f"const uint16_t rest_pause = 0x{int((rest_pause/0.000064)-1):04X};\n")
